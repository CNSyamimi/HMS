<%-- src/main/webapp/adminStudentList.jsp --%>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="action-buttons">
                <a href="adminStudentManagement?action=add" class="btn btn-success">Add New Student</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="student" items="${requestScope.studentList}">
                        <tr>
                            ...
                            <td>
                                <a href="adminStudentManagement?action=edit&studentID=${student.studentID}" class="btn btn-warning">Edit</a>
                                <a href="adminStudentManagement?action=delete&studentID=${student.studentID}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete student ${student.SName}?');">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
